...
;
    ...
    class ParticleEmitterDefinition
   {
      ...
      public var mImageRow:Float = Math.NaN;
      ...
      public var mParticleFields:Array<ASAny>;
      
      public var mCollisionSpin:FloatParameterTrack;
      
      public var mAnimationRate:FloatParameterTrack;
      
      public var mAnimated:Bool = false;
      
      public var mImageCol:Float = Math.NaN;
      
      public var mEmitterRadius:FloatParameterTrack;
      
      public var mImageFrames:Float = Math.NaN;
      ...
      public var mSystemFields:Array<ASAny>;
      ...
      public function new()
      {
         ...
         this.mParticleFields = new Array<ASAny>();
         this.mSystemFields = new Array<ASAny>();
      }
