...
;
    ...
    class CWidgetManager extends CWidgetContainer
   {
      ...
      public function setBaseModal(param1:CWidget, param2:CFlagsMod) 
      {
         ...
         if(this.overWidget != null && (Std.int(this.belowModalFlagsMod.removeFlags )& Std.int(WIDGETFLAGS_ALLOW_MOUSE )) != 0&& isBelow(this.overWidget,this.baseModalWidget))
         {
            _loc3_ = this.overWidget;
            this.overWidget = null;
            this.doMouseLeave(_loc3_);
         }
         if(this.lastDownWidget != null && (Std.int(this.belowModalFlagsMod.removeFlags )& Std.int(WIDGETFLAGS_ALLOW_MOUSE )) != 0&& isBelow(this.lastDownWidget,this.baseModalWidget))
         {
         ...
         if(this.focusWidget != null && (Std.int(this.belowModalFlagsMod.removeFlags )& Std.int(WIDGETFLAGS_ALLOW_FOCUS )) != 0&& isBelow(this.focusWidget,this.baseModalWidget))
         {
