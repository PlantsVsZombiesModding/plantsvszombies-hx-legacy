...
class PVZParticleLoader {
	...
	public static function init(param1:ASDictionary<ASAny, ASAny>) {
		...
		param1[PVZParticles.PARTICLE_ZOMBIENEWSPAPERHEAD] = new ByteParticleDescriptor((Type.createInstance(PARTICLE_ZOMBIENEWSPAPERHEAD_CLASS,
			[]) : ByteArray));
		...
		param1[PVZParticles.PARTICLE_ZOMBIEPOLEVALUTHEAD] = new ByteParticleDescriptor((Type.createInstance(PARTICLE_ZOMBIEPOLEVALUTHEAD_CLASS,
			[]) : ByteArray));
