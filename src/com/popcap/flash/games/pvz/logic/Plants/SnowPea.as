package com.popcap.flash.games.pvz.logic.Plants
{
   ...
   public class SnowPea extends CPlant
   {
       
      
      public function SnowPea(theGridX:int, theGridY:int, theSeedType:int, app:PVZApp, theBoard:Board)
      {
         //super();
         this.app = app;
         mBoard = theBoard;
         ...
         mBodyReanimation = app.reanimator.createReanimation(PVZReanims.REANIM_SNOWPEA);
         ...
         if(mBodyReanimation)
         {
            ...
            mHeadReanimation = app.reanimator.createReanimation(PVZReanims.REANIM_SNOWPEA);
      ...
      public function Fire(theTargetZombie:Zombie, theRow:int, thePlantWeapon:int) : void
      {
         ...
         app.foleyManager.playFoley(PVZFoleyType.SNOW_PEA_SPARKLES);
         ...
         var anEffect:ParticleSystem = app.particleManager.spawnParticleSystem(PVZParticles.PARTICLE_SNOWPEAPUFF);
