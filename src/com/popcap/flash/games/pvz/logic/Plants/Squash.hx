...
aZombie  = _tmp_;
            ...
            if(aRowDiff == 0)
            {
               if(aZombie.mHasHead)
               {
                  ...
                  {
                     if(aZombie.mZombiePhase == CPlant.PHASE_POLEVAULTER_PRE_VAULT || aZombie.mZombiePhase == CPlant.PHASE_POLEVAULTER_IN_VAULT)
                     {
                        continue;
                     }
                  }
                  ...
                  if(aDist <= aRange)
                  {
                     ...
                     if(aZombie.mZombiePhase == CPlant.PHASE_POLEVAULTER_POST_VAULT || aZombie.mZombiePhase == CPlant.PHASE_POLEVAULTER_PRE_VAULT)
                     {
