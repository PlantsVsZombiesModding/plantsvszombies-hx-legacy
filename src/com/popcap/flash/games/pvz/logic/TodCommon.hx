...
i++;
      ...
      public static function TodAnimateCurveFloat(theTimeStart:Int, theTimeEnd:Int, theTimeAge:Int, thePositionStart:Float, thePositionEnd:Float, theCurve:Int) : Float
      {
...
i++;
         ...
         aPickIndex = 0;while(aPickIndex < theCount - 1)
         {
