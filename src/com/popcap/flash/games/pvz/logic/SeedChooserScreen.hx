...
i++;
         ...
         {
            var i :ASAny= 0;while(i < this.mBoard.mSeedBank.mNumPackets)
            {
...
i++;
      ...
      public function CloseSeedChooser() 
      {
         ...
         var i= 0;while(i < this.mBoard.mSeedBank.mNumPackets)
         {
...
i++;
      ...
      public function ClickedSeedInBank(theChosenSeed:ChosenSeed) 
      {
         ...
         var aPoint= new Point();
         var i= theChosenSeed.mSeedIndexInBank + 1;while(i < this.mBoard.mSeedBank.mNumPackets)
         {
...
i++;
      ...
      override public function onMouseDown(x:Float, y:Float) 
      {
         ...
         if(this.mSeedsInFlight > 0)
         {
            var i :ASAny= 0;while(i < NUM_SEEDS_IN_CHOOSER)
            {
...
i++;
      ...
      override public function draw(g:Graphics2D) 
      {
         ...
         var i :ASAny= 0;while(i < aNumPlacesInBank)
         {
