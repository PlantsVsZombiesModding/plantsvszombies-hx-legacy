...
aPlant  = _tmp_;
      ...
      public function ScaryPotterPlacePot(theScaryPotType:Int, theZombieType:Int, theSeedType:Int, theCount:Int, theGridArray:Array<ASAny>, theGridArrayCount:Int) 
      {
      ...
      public function SpawnZombieWave() 
      {
         ...
         if(this.app.IsSurvivalMode() && this.mBoard.mBackground == Board.BACKGROUND_2_NIGHT)
         {
            if(this.mBoard.mCurrentWave == this.mBoard.mNumWaves - 1)
            {
               ...
               var i :ASAny= 0;while(i < this.mSurvivalStage + 1)
               {
                  if(aCount < 12)
                  {
...
i++;
      ...
      public function ScaryPotterChangePotType(thePotType:Int, theCount:Int) 
      {
         ...
         var i= 0;while(i < this.mBoard.mGridItems.length)
         {
...
i++;
         ...
         var i :ASAny= 0;while(i < theCount)
         {
...
i++;
      ...
      public function UpdateConveyorBelt() 
      {
         ...
         var i :ASAny= 0;while(i < aNumSeedsType)
         {
