...
;
    ...
    class Coin extends GameObject
   {
      ...
      public function MouseHitTest(theX:Int, theY:Int, theHitResult:HitResult) : Bool
      {
         ...
         else if(this.mType == COIN_USABLE_SEED_PACKET && mBoard != null && mBoard.mCursorObject.mCursorType != Board.CURSOR_TYPE_NORMAL)
         {
            aResult = false;
         }
      ...
      public function Collect() 
      {
         ...
         else
         {
            ...
            {
               var i :ASAny= 0;while(i < mBoard.mSeedBank.mNumPackets)
               {
