...
class Zombie extends GameObject {
	...
	public function IsDeadOrDying():Bool {
		if (this.mDead
			...
			|| this.mZombiePhase == PHASE_ZOMBIE_BURNED
			|| this.mZombiePhase == PHASE_ZOMBIE_MOWERED) {
			return true;
		}
	...
	public function UpdateDeath() {
		...
		if (this.mZombieType == ZOMBIE_NORMAL
			|| this.mZombieType == ZOMBIE_FLAG
			|| this.mZombieType == ZOMBIE_TRAFFIC_CONE
			|| this.mZombieType == ZOMBIE_PAIL) {
