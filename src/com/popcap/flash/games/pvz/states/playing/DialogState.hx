	...
	public function onEnter() {
		...
		if (this.app.mBoard.mGameScene == Board.SCENE_ZOMBIES_WON) {
			if (this.app.IsAdventureMode()) {
				...
				this.app.mDialogBox.InitializeDialogBox(this.app.stringManager.translateString("[GAME_OVER]"), "",
					this.app.stringManager.translateString("[TRY_AGAIN]"), "", 1, 1);
				...
				this.app.mDialogBox.InitializeDialogBox(this.app.stringManager.translateString("[SCARY_POTTER_ENDLESS]"), aMessage,
					this.app.stringManager.translateString("[TRY_AGAIN]"), "", 4, 1);
				...
				this.app.mDialogBox.InitializeDialogBox(this.app.stringManager.translateString("[SURVIVAL_POOL_ENDLESS]"), aCompletedStr,
					this.app.stringManager.translateString("[TRY_AGAIN]"), "", 4, 2);
			}
		}
	}
