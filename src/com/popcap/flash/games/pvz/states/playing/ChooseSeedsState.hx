...
class ChooseSeedsState implements IState {
	public static inline final SEED_CHOOSER_OFFSETSCREEN_OFFSET = 348;

	public static inline final TimeSeedChoserSlideOnStart = 500;

	public static inline final SEED_CHOOSER_STARTBUTTON_OFFSET = 713;

	public static final TimeSeedChoserSlideOnEnd:Int = TimeSeedChoserSlideOnStart + 250;

	public static final TimeSeedChoserSlideOffStart:Int = TimeSeedChoserSlideOnEnd + 250;

	public static final TimeSeedChoserSlideOffEnd:Int = TimeSeedChoserSlideOffStart + 250;
	...
	public function update() {
		...
		if (this.app.mSeedChooserScreen.mChooseState == SeedChooserScreen.CHOOSE_ENTER
			...
			|| this.app.mSeedChooserScreen.mChooseState == SeedChooserScreen.CHOOSE_VIEW_LAWN) {
			this.app.mCutsceneTime += 10;
		}
		var aTimeSeedChoserSlideOnStart = TimeSeedChoserSlideOnStart;
		var aTimeSeedChoserSlideOnEnd = TimeSeedChoserSlideOnEnd;
		if (this.app.mSeedChooserScreen.mChooseState == SeedChooserScreen.CHOOSE_ENTER) {
			...
			if (this.app.mCutsceneTime > aTimeSeedChoserSlideOnStart && this.app.mCutsceneTime <= aTimeSeedChoserSlideOnEnd) {
				...
				posEnd = 0;
				y = TodCommon.TodAnimateCurve(aTimeSeedChoserSlideOnStart, aTimeSeedChoserSlideOnEnd, this.app.mCutsceneTime, posStart, posEnd,
					TodCommon.CURVE_EASE_IN_OUT);
				this.app.mSeedChooserScreen.move(0, y);
				posStart = SEED_CHOOSER_STARTBUTTON_OFFSET;
				posEnd = 370;
				aButtonY = TodCommon.TodAnimateCurve(aTimeSeedChoserSlideOnStart, aTimeSeedChoserSlideOnEnd, this.app.mCutsceneTime, posStart, posEnd,
					TodCommon.CURVE_EASE_IN_OUT);
		...
		var aTimeSeedChoserSlideOffStart = TimeSeedChoserSlideOffStart;
		var aTimeSeedChoserSlideOffEnd = TimeSeedChoserSlideOffEnd;
		if (this.app.mSeedChooserScreen.mChooseState == SeedChooserScreen.CHOOSE_LEAVE
			|| this.app.mSeedChooserScreen.mChooseState == SeedChooserScreen.CHOOSE_VIEW_LAWN) {
			...
			if (this.app.mCutsceneTime > aTimeSeedChoserSlideOffStart && this.app.mCutsceneTime <= aTimeSeedChoserSlideOffEnd) {
				...
				y = TodCommon.TodAnimateCurve(aTimeSeedChoserSlideOffStart, aTimeSeedChoserSlideOffEnd, this.app.mCutsceneTime, posStart, posEnd,
					TodCommon.CURVE_EASE_IN_OUT);
				this.app.mSeedChooserScreen.move(0, y);
