...
class PVZFoleyType {
	...
	public static final SUN:FoleyType = new FoleyType(10, [
		PVZSounds.SOUND_POINTS1,
		PVZSounds.SOUND_POINTS2,
		PVZSounds.SOUND_POINTS3,
		PVZSounds.SOUND_POINTS4,
		PVZSounds.SOUND_POINTS5
	], FoleyFlags.NONE);

	public static final CRAZYDAVEEXTRALONG:FoleyType = new FoleyType(0, [
		PVZSounds.SOUND_CRAZYDAVEEXTRALONG1,
		PVZSounds.SOUND_CRAZYDAVEEXTRALONG2,
		PVZSounds.SOUND_CRAZYDAVEEXTRALONG3
	], new FoleyFlags(FoleyFlags.DONT_REPEAT));
	...
	public static final BRAINS:FoleyType = new FoleyType(0, [
		PVZSounds.SOUND_GROAN,
		PVZSounds.SOUND_GROAN2,
		PVZSounds.SOUND_GROAN3,
		PVZSounds.SOUND_GROAN4,
		PVZSounds.SOUND_GROAN5,
		PVZSounds.SOUND_GROAN6
	], FoleyFlags.NONE);
	...
	public static final NEWSPAPER_RARRGH:FoleyType = new FoleyType(-2, [
		PVZSounds.SOUND_NEWSPAPER_RARRGH,
		PVZSounds.SOUND_NEWSPAPER_RARRGH2,
		PVZSounds.SOUND_NEWSPAPER_RARRGH2
	], FoleyFlags.NONE);
	...
	public static final DIGGER:FoleyType = new FoleyType(0, [PVZSounds.SOUND_DIGGER_ZOMBIE],
		new FoleyFlags(FoleyFlags.LOOP | FoleyFlags.ONE_AT_A_TIME | FoleyFlags.MUTE_ON_PAUSE));
	...
	public static final CRAZYDAVESHORT:FoleyType = new FoleyType(0, [
		PVZSounds.SOUND_CRAZYDAVESHORT1,
		PVZSounds.SOUND_CRAZYDAVESHORT2,
		PVZSounds.SOUND_CRAZYDAVESHORT3
	], new FoleyFlags(FoleyFlags.DONT_REPEAT));
	...
	public static final LIMBS_POP:FoleyType = new FoleyType(10, [
		PVZSounds.SOUND_LIMBS_POP1,
		PVZSounds.SOUND_LIMBS_POP2,
		PVZSounds.SOUND_LIMBS_POP3,
		PVZSounds.SOUND_LIMBS_POP4,
		PVZSounds.SOUND_LIMBS_POP5
	], FoleyFlags.NONE);
	...
	public static final CRAZYDAVELONG:FoleyType = new FoleyType(0, [
		PVZSounds.SOUND_CRAZYDAVELONG1,
		PVZSounds.SOUND_CRAZYDAVELONG2,
		PVZSounds.SOUND_CRAZYDAVELONG3
	], new FoleyFlags(FoleyFlags.DONT_REPEAT));
	...
	public static final SQUASH_HMM:FoleyType = new FoleyType(2, [
		PVZSounds.SOUND_SQUASH_HMM,
		PVZSounds.SOUND_SQUASH_HMM,
		PVZSounds.SOUND_SQUASH_HMM2
	], FoleyFlags.NONE);
	...
	public static final GROAN:FoleyType = new FoleyType(0, [
		PVZSounds.SOUND_GROAN,
		PVZSounds.SOUND_GROAN2,
		PVZSounds.SOUND_GROAN3,
		PVZSounds.SOUND_GROAN4,
