package com.popcap.flash.games.pvz.logic.Plants
{
   ...
   public class LeftPeater extends CPlant
   {
       
      
      public function LeftPeater(theGridX:int, theGridY:int, theSeedType:int, app:PVZApp, theBoard:Board)
      {
         super();
         this.app = app;
         mBoard = theBoard;
      ...
      public function Fire(theTargetZombie:Zombie, theRow:int, thePlantWeapon:int) : void
      {
         ...
         if(mSeedType == SEED_PEASHOOTER || mSeedType == SEED_SNOWPEA || mSeedType == SEED_REPEATER || mSeedType == SEED_LEFTPEATER)
         {
