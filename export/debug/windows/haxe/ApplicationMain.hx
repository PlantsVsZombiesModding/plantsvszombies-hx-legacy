...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("export", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("export", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "6";
		app.meta["company"] = "popcap";
		app.meta["file"] = "export";
		app.meta["name"] = "export";
		app.meta["packageName"] = "com.popcap.flash";
